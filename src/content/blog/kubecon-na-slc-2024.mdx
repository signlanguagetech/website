...
import AlMlOperationalSidesTalk from '/public/al-ml-operational-sides-talk.webp'
import SlcView from '/public/slc-view.webp'
import SignLanguageCrashCourse from '/public/sign-language-crash-course.webp'
import SlcMountainMetal from '/public/slc-mountain-metal.webp'
...
<Image 
  src={AlMlOperationalSidesTalk}
  alt='two men standing on the stage presenting the talk'
  layout="responsive"
  width={640}
  height={480}
/>
...
<Image 
  src={SlcView}
  alt='Aerial view of the city of SLC'
  layout="responsive"
  width={640}
  height={480}
/>
...
<Image 
  src={SignLanguageCrashCourse}
  alt='crowded people learning and collaborating at sign language crash course'
  layout="responsive"
  width={640}
  height={480}
/>
...
<Image 
  src={SlcMountainMetal}
  alt='A rust-colored metal sculpture resembling mountain peaks spelling SLC'
  layout="responsive"
  width={640}
  height={480}
/>
